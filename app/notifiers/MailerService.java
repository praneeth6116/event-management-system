...
public class MailerService {
    ...
    public int sendEmail(MailerClient mclient){
        ...
        //{
            ...
            email.setFrom("eventmanagementsystem111@gmail.com");
            email.addTo("eventmanagementsystem3@gmail.com");
    ...
    public void verifyUser(User user)
    {
        ...
        email.setFrom("eventmanagementsystem111@gmail.com");
        email.addTo(user.getUserEmail());
        email.setBodyText("Your mail-id has been used to create an account in EventManagementSystem. If this action is not performed by you. Please contact EventManagementSystem.");
        mailerClient.send(email);
    }
	...
	public void bookingConfirmation(Share s, Event event)
    {
        Email email = new Email();
        email.setSubject("Booking confirmation mail");
        email.setFrom("eventmanagementsystem111@gmail.com");
        email.addTo(s.getAdvertiserMail());
        email.setBodyText("Your booking for the event" +" "+event.getEventName()+" is confirmed. Share id: "+s.getShareId());
        mailerClient.send(email);
    }
	...
	public void cancelConfirmation(Event event, User user, int shareId)
    {
        Email email = new Email();
        email.setSubject("Share cancellation confirmation");
        email.setFrom("eventmanagementsystem111@gmail.com");
        email.addTo(user.getUserEmail());
        email.setBodyText("Your event share has been cancelled");
        email.setBodyHtml("<html><body> <h2>Share Details</h2>" +
                "        <ul>" +
